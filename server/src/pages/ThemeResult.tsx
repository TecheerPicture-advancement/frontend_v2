...
const ThemeResult: React.FC = () => {
  ...
  const handleThemeSelect = (themeDetails: ThemeDetails) => {
    ...
    console.log("Selected Theme Details:", themeDetails);
    setIsThemeSelected(true);
    window.scrollTo({ top: 0, behavior: 'smooth' });
    if (themeDetails.theme !== '직접입력') {
      setTimeout(() => {
        window.scrollTo({ top: 0, behavior: 'smooth' });
  ...
  console.log('Selected Theme:', selectedTheme.theme);
                    ...
                    <div className="relative flex flex-col items-start justify-between flex-grow-0 flex-shrink-0 gap-20">
                      ...
                      {selectedTheme.theme === '직접입력' && (
                        <textarea
                          ...
                          value={customTheme}
                          onClick={() => handleThemeSelect({ imageSource: selectedTheme.imageSource, detail: selectedTheme.detail, theme: '직접입력', sentence: selectedTheme.sentence })}
